...
alive_c += f"__↼ 𝙾𝚆𝙽𝙴𝚁 ⇀__      : 『 {hell_mention} 』\n\n"
alive_c += f"•★• 𝚃𝙴𝙻𝙴𝚃𝙷𝙾𝙽       :  `{tel_ver}` \n"
alive_c += f"•★• 𝚂𝙼𝙾𝙺𝙴𝚁 𝙱𝙾𝚃     :  __**{hell_ver}**__\n"
alive_c += f"•★• 𝚂𝚄𝙳𝙾           :  `{is_sudo}`\n"
alive_c += f"•★• **[𝙲𝚁𝙴𝙰𝚃𝙾𝚁]**(https://t.me/S_M_O_K_E_R_R)
